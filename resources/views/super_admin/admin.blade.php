                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Admin List 
                                <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#exampleModal" style="float: right;"><span class="fa fa-plus"></span> Add</button>
                            </div>
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <button class="btn btn-info" data-toggle="modal" type="button" data-target="#profileModal{{ $data->id }}"><span class="fa fa-eye"></span></button>
                                            <button class="btn btn-warning" data-toggle="modal" type="button" data-target="#editModal{{ $data->id }}"><span class="fa fa-edit"></span></button>
                                            <button class="btn btn-danger" data-toggle="modal" type="button" data-target="#deleteModal{{ $data->id }}"><span class="fa fa-trash"></span></button>
