...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Report Detail</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="/user_report">User Report</a></li>
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                               ...
                               Offender email: {{ $offender_email }}   
                               
                               <div style="float:right"> <a data-toggle="modal" data-id="{{ $offender_email }}" class="banData btn btn-danger"  href="#reportModal"><span class="fa fa-ban"></span> Ban User</a>
                                <a data-toggle="modal" data-id="{{ $offender_email }}" class="unbanData btn btn-success"  href="#unbanModal"><span class="fa fa-check"></span> Unban User</a></div>

                                </div>
                                @include('super_admin.reportModal')
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <tr>
                                        <td>{{ $no }}</td>
                                        <td>{{ $data->reporter_username }}</td>
                                        <td>{{ $data->report_type}}</td>
                                        <td style="text-align:center"> 
                                           <button class="btn btn-info" data-toggle="modal" type="button" data-target="#reportInfoModal{{$data->id}}"><span class="fa fa-eye"></span> Info</button>
                                        </td>
                                    </tr>
        ...
        <script>
            $(document).on("click", ".banData", function () {
            var offender_email = $(this).data('id');
            $(".modal-content #offender_email").val( offender_email );
            });
        </script>
        <script>
            $(document).on("click", ".unbanData", function () {
            var offender_email = $(this).data('id');
            $(".modal-content #offender_email").val( offender_email );
            });
        </script>
