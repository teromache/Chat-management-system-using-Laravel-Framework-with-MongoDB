...
class PrintController extends Controller
{
    ...
    public function printPreview()
    {
        ...
        return view('super_admin.printPreview',compact('bs_count','fn_count','aw_count','study_count','game_count','lazy_count','talk_count','eat_count','sleep_count','discuss_count','jan_count','feb_count','mac_count','apr_count','may_count','jun_count','jul_count','aug_count','sep_count','oct_count','nov_count','dec_count'));
